...
## Stage 4: From Admin to LFI and Source Code Retrieval
...
The server responded with the contents of `/etc/passwd`. From here, I extracted the `.env` file and read the hidden SQL Server database credentials.
