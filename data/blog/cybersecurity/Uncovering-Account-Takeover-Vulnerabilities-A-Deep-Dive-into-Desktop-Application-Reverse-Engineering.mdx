...
<ext_data>
    <ext_k>000102030405060708090a0b0c0e0e0e</ext_k>
    <ext_i>101112131415161718191a1b1c1e1e1e</ext_i>
</ext_data>
```
...
<AUTH Username="AMIL007" 
      AccessToken="0afb790c7e6f4a5ab28b5ee01c1b1914" 
      BroadcasterIP="ssibc5.target.com" 
      BroadcasterPort="8080" 
      BroadcasterPass="317318f95d5bb9fdd94f5ce9199609f7" />
```
