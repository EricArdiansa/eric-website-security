...
![dnSpy AES Key GlobalVars](/static/images/ato-desktop/dnspy-aes-key.png)
...
![Burp Suite AES Key Leak](/static/images/ato-desktop/burp-extdata.png)
...
![Python Decryptor BroadcasterPass](/static/images/ato-desktop/python-decrypt.png)
...
![Redis Session Token Dump](/static/images/ato-desktop/redis-session-dump.png)
